...
const MentionsLegales = () => {
    return(
        <Fragment>
            ...
            <h2>Hébergement</h2>
            <p>
                Le Site est hébergé par la société 3WA, situé Rue de la 3WA 44000 NANTES, (contact téléphonique ou email : +33102030405).
            </p>
            ...
            <h2>Nous contacter</h2>
            <p>
                Le traitement de vos données à caractère personnel est régi par notre Charte du respect de la vie privée, disponible depuis la 
